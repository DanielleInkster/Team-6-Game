...
## Personal Reflection
I really enjoyed working on this project. It was a great challenge to learn a new language by doing – if a bit overwhelming at times! I learned a lot about the syntax of Swift; the backend is syntactically similar to JavaScript and I was able to make some parallels between the frontend (Storyboards) and some of the methods found JavaScript libraries, such as React and JQuery. For this project, I contributed a lot to the backend, such as designing the game model and making the score and rank persist between storyboards. This project reaffirmed for me that I am able to pick up a new language quickly and am able to work effectively under pressure. This project was also a great opportunity to put Agile practices in place to improve overall team performance and end-product quality. 
